...
namespace Rendering
{
    ...
    TriangleDemo::TriangleDemo(Game& game, Camera& camera, wstring TextureName)
    ...
    shaderFlags |= D3DCOMPILE_SKIP_OPTIMIZATION;
		...
		{
			TextureMappingVertex(XMFLOAT4(-width, 0.0f, length, 1.0f), XMFLOAT2(0.0f, 1.0f)),
			TextureMappingVertex(XMFLOAT4(+width, 0.0f, length, 1.0f), XMFLOAT2(1.0f, 1.0f)),
			TextureMappingVertex(XMFLOAT4(+width, 0.0f, -length, 1.0f), XMFLOAT2(1.0f, 0.0f)),
			TextureMappingVertex(XMFLOAT4(-width, 0.0f, -length, 1.0f), XMFLOAT2(0.0f, 0.0f)),
		};
